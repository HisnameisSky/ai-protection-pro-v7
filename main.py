...
class AntiAIPortraitApp:
    ...
    def _build_doc_ui(self):
        ...
        tk.Button(f, text=t["select_file"], command=self._select_doc_file, bg=self.btn_bg, fg=self.text_color, activebackground=self.accent_color, activeforeground="#ffffff", font=("Helvetica", 9, "bold"), relief="flat", bd=0, padx=10, pady=5).pack()
    ...
    def _build_audit_ui(self):
        ...
        self.audit_net_btn = tk.Button(self.audit_net_frame, text=t["btn_net_check"], command=self._audit_net, bg=self.btn_bg, fg=self.text_color, activebackground=self.accent_color, relief="flat", bd=0, padx=10)
        ...
        tk.Button(btn_box, text=t["select_file"], command=self._select_audit_file, bg=self.btn_bg, fg=self.text_color, activebackground=self.accent_color, relief="flat", bd=0, padx=10, pady=3).pack(side="left")
    ...
    def _select_files(self):
        ...
        if files:
            ...
            if count == 1: 
                self.drop_label.configure(text=f"選択済み: {os.path.basename(self.selected_file_paths[0])}", fg=self.accent_color)
            else: 
                self.drop_label.configure(text=f"選択済み: {count} 枚のイラスト", fg=self.accent_color)
